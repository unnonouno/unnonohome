...
def install_pyenv():
    sudo('apt-get install -yq curl git libbz2-dev libreadline-dev libssl-dev libsqlite3-dev')
    run('curl -L https://raw.githubusercontent.com/yyuu/pyenv-installer/master/bin/pyenv-installer | bash')


def install_ubuntu():
    sudo('apt-get install -yq emacs gcc git lv mercurial source-highlight texinfo tig tmux xsel zip zsh')
